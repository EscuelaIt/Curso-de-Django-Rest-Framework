...
class AuditAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (
            ...
            {"fields": ("affected_table", "record_id", "operation", "operation_date")},
        ),
        (
            "Usuario y Contexto",
            {"fields": ("user", "context", "ip_address", "user_agent")},
        ),
        (
            "Datos Anteriores",
            {"fields": ("previous_data_formatted",), "classes": ("collapse",)},
        ),
        ("Datos Nuevos", {"fields": ("new_data_formatted",), "classes": ("collapse",)}),
        (
            "Resumen de Cambios",
            {"fields": ("changes_summary_detailed",), "classes": ("wide",)},
        ),
    )
    ...
    def operation_display_colored(self, obj):
        ...
        colors = {"INSERT": "green", "UPDATE": "orange", "DELETE": "red"}
