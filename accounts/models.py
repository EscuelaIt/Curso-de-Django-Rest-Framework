...
class SavingsAccount(models.Model):
    ...
    account_number = models.CharField(
        max_length=20, unique=True, help_text="Unique bank account number"
    )
    ...
    opening_date = models.DateTimeField(
        auto_now_add=True, help_text="Account opening date"
    )
    last_movement_date = models.DateTimeField(
        null=True, blank=True, help_text="Date of last transaction"
    )
